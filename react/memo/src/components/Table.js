...
class Table extends Component {
  ...
  handleClickTerm = async tid => {
    console.log('Dans handleClickTerm - id du terme cliqué : ', tid);
    // Je peux aller chercher les colonnes et les cartes qui concernent ce terme
    const columns = await this.coop.getCards(this.user, this.token, tid);
  ...
  render() {
    return (
      <div>
        ...
        <main>
          Bientôt, les colonnes avec leurs cartes ici !
